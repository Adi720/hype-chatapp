...
const Auth = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // while creating account storing additional data to cookies
        if (!isSignup) {
        ...
        // Reloading browser
        // Why? => bcz when we will reload the application authToken will not be false and Chat window would be displayed 
